...
# --- 3. CSS INTELIGENTE (PROTEGE O LOGIN, FORÇA O CALENDÁRIO) ---
st.markdown("""
<style>
    ...
    /* ============================================================ */
    /* 🧠 CSS SELETIVO: SÓ AFETA O CALENDÁRIO (linhas com >5 cols)  */
    /* ============================================================ */
    
    @media only screen and (max-width: 768px) {
        
        /* O seletor :has() verifica se o bloco tem uma 6ª coluna (Calendário tem 8) */
        /* Se tiver, aplica o layout horizontal. Se não (Login tem 3), ignora. */
        ...
        /* Aplica largura mínima SOMENTE nas colunas desses blocos largos */
        div[data-testid="stHorizontalBlock"]:has(> div[data-testid="column"]:nth-child(6)) > div[data-testid="column"] {
            flex: 0 0 auto !important;
            width: auto !important;
            min-width: 100px !important;        /* Largura mínima do dia */
        }
        
        /* Fixa a primeira coluna (Hora) apenas no calendário */
        div[data-testid="stHorizontalBlock"]:has(> div[data-testid="column"]:nth-child(6)) > div[data-testid="column"]:first-child {
    ...
    /* Design do Cartão de Login (Sem afetar layout) */
    ...
    /* Estilo da Agenda (Células) */
    div[data-testid="stVerticalBlock"] button[kind="secondary"] {
        background-color: #f0fdf4 !important; border: 1px solid #bbf7d0 !important; color: #15803d !important;
        font-size: 11px !important; font-weight: 600; height: 40px !important; min-height: 40px !important; border-radius: 4px; width: 100% !important;
    }
...
def render_calendar(sala, is_admin_mode=False):
    ...
    if mode == 'MÊS':
        # ... (Mantido código do mês igual V86) ...
        ...
        # (Lógica de busca e render mês simplificada para caber, igual V86)
        reservas = []
        try:
        ...
        # 1. CABEÇALHO
        # ratios = [0.4] + [1]*num_days (Ajustado no CSS para ser Grid quando mobile)
