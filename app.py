...
# --- 3. CSS VISUAL & HACKS DE LAYOUT (MOBILE SCROLL FORCE) ---
st.markdown("""
<style>
    ...
    /* ============================================================ */
    /* 📱 MOBILE SCROLL FORCE - O "HACK" PARA NÃO EMPILHAR          */
    /* ============================================================ */
    
    @media only screen and (max-width: 768px) {
        
        /* 1. Alvo: Container que segura as colunas (grade da agenda) */
        ...
        /* 2. Alvo: As Colunas Individuais (Dias da semana) */
        div[data-testid="column"] {
            flex: 0 0 auto !important;          /* Não encolher, tamanho rígido */
            width: auto !important;
            min-width: 130px !important;        /* LARGURA MÍNIMA: Garante que o dia não esmague */
        }
        
        /* 3. Ajuste Fino: Coluna da Hora (A primeira da esquerda) */
        /* Deixamos ela fixa (Sticky) para não sumir ao rolar */
    ...
    /* Eventos e Bloqueios */
    .evt-chip { background: white; border-left: 4px solid #0d9488; box-shadow: 0 1px 2px rgba(0,0,0,0.05); color: #0f766e; font-size: 11px; font-weight: 600; padding: 6px 8px; border-radius: 4px; margin-bottom: 4px; display: flex; align-items: center; justify-content: center; height: 38px; }
    .admin-blocked { background: #334155; color: #f8fafc; border-radius: 4px; font-size: 10px; font-weight: bold; text-align: center; padding: 8px; height: 38px; display: flex; align-items: center; justify-content: center; }
    .blocked-slot { background-color: #fef2f2; height: 38px; border-radius: 6px; border: 1px solid #fecaca; opacity: 0.7; margin-bottom: 5px; }
            ...
            for i, d in enumerate(visiveis):
                ...
                if res:
                    ...
                    if not is_admin_mode:
                        ...
                        cont.markdown("<div style='height:38px; border-left:1px dashed #cbd5e1'></div>", unsafe_allow_html=True)
